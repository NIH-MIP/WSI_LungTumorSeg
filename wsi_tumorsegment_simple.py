...
class extractPatch:
    ...
    def __init__(self):
        self.file_location = args.file_location #'/data/AIR/Chen_AI/PartA/PartA2/Raw Images/Exp 100 HE'#'R:/Chen_AI/PartA/PartA2/Raw Images/Exp 100 HE'
        self.image_file = args.image_file #'1044 - 2020-08-10 08.39.18.ndpi'#'1043 - 2020-08-10 08.48.55.ndpi'
        # self.xml_file = args.xml_file #'/data/AIR/Chen_AI/PartA/PartA2/geoJSON files/20210220 geoJSON files/E100/1044 - 2020-08-10 08.39.18.ndpi.json'#'R:/Chen_AI/PartA/PartA2/geoJSON files/20210220 geoJSON files/E100/1043 - 2020-08-10 08.48.55.ndpi.json' #if you dont have an xml file specify 'none'
        self.save_location = args.save_dir #'/data/AIR/Chen_AI/Data/json_output'
        ...
        self.model_path = './models/deeplabv3_resnet50_10ep_lr1e4_nonorm.pkl' #path to model file
